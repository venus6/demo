...
<div id="pic_slider" class="venus-slider">
    <ul>
        <li><a href=""><img src="<?php echo $this->config->item('public_url'); ?>img/front/banner_index_1.jpg" alt="" /></a></li>
        <li><a href=""><img src="<?php echo $this->config->item('public_url'); ?>img/front/banner_index_2.jpg" alt="" /></a></li>
        <li><a href=""><img src="<?php echo $this->config->item('public_url'); ?>img/front/banner_index_3.jpg" alt="" /></a></li>
    </ul>
    <ol>
        <li class="current"></li>
        <li></li>
