...
class MY_Pagination extends CI_Pagination {
	public function initialize(array $params = array())
	{
		...
		//add by venus
		if (isset($this->total_rows) && !empty($this->total_rows)) {
			$this->full_tag_close = str_replace('total_rows', $this->total_rows, $this->full_tag_close);
		}
	...
	public function create_links()
	{
		...
		{
			//modify by venus
			return $this->full_tag_open . '没有记录' . '</div>';
		}
