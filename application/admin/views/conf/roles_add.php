    ...
    <div class="dialog-content">
        <fieldset class="box">
            ...
            <?php foreach ($v['second'] as $k2 => $v2): ?>
                <input type="checkbox" name="priv[]" id="priv_id_<?php echo $k; ?>_<?php echo $k2; ?>" value="<?php echo $v2['id']; ?>" class="ml_5" /><label for="priv_id_<?php echo $k; ?>_<?php echo $k2; ?>" class="ml_5"><?php echo $v2['name']; ?></label>
            <?php endforeach; ?>
            <?php endforeach; ?>
        </fieldset>
    </div>
