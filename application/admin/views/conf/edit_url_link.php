<div id="dialog" class="dialog" style="width: 500px; height: 400px; ">
    <div class="dialog-head">
        <div class="dialog-title flt">编辑友情链接</div><a href="javascript:void(0)" class="btn-close frt" onclick="Mui.box.close()" title="关闭"><b>关闭</b></a>
    </div>
    ...
    <div class="dialog-content">
        <fieldset class="box">
            ...
            <input type="text" name="title" id="title" value="<?php echo $content_info['title']; ?>" class="box" />
            <label class="box" for="url_link">链接 <span class="required">*</span></label>
            <input type="text" name="url_link" id="url_link" value="<?php echo $content_info['url_link']; ?>" class="box" />
            <label class="box" for="sort">排序  <span class="required">*</span></label>
            <input type="text" name="sort" id="sort" value="<?php echo $content_info['sort']; ?>" class="box only_num" />
        </fieldset>
    </div>
