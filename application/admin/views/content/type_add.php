<div id="dialog" class="dialog" style="width: 500px; height: 400px; ">
    <div class="dialog-head">
        <div class="dialog-title flt">添加子类别</div><a href="javascript:void(0)" class="btn-close frt" onclick="Mui.box.close()" title="关闭"><b>关闭</b></a>
    </div>
    ...
    <div class="dialog-content">
        <fieldset class="box">
            ...
            <input type="text" name="sort" id="sort" class="box only_num" value="1" />
        </fieldset>
    </div>
