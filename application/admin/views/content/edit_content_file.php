...
<article>
    <div class="title">
        <span class="nav"><a href="<?php echo site_url('content/type/column_list'); ?>">栏目管理</a><?php if (isset($p_type_info)): ?> &gt; <a href="<?php echo site_url('content/type/into_column/' . $p_type_info['id']); ?>"><?php echo $p_type_info['name']; ?></a><?php endif; ?> &gt; <a href="<?php echo site_url('content/type/into_column/' . $type_info['id']); ?>"><?php echo $type_info['name']; ?></a> &gt; 编辑内容</span>
        <span class="count_info"></span>
    </div>
    <form id="submit_form" method="post" action="<?php echo site_url('content/type/do_edit_content'); ?>" >
    <input type="hidden" name="id" value="<?php echo $content_info['id']; ?>" />
    ...
    <div class="op_block">
        <div class="form_content">
            ...
            <input type="text" class="box" name="title" id="title" value="<?php echo $content_info['title']; ?>" />
            <label class="box" for="article_content">内容</label>
            <textarea name="content" id="article_content" style="width:100%;height:500px;"><?php echo $content_info['content']; ?></textarea>
            <label class="box" for="sel_img"><?php if ($content_info['file_url'] != ''): ?>已存在<?php endif; ?>文件 <span class="required">文件大小不能超过1MB</span></label>
            ...
            <input id="img_url" name="file_url" type="hidden" value="<?php echo $content_info['file_url']; ?>" />
            <label class="box" for="sort">排序 <span class="required">*</span></label>
            <input type="text" class="box only_num" name="sort" id="sort" value="<?php echo $content_info['sort']; ?>" />
            <div class="form_foot">
                <div class="btnlist">
